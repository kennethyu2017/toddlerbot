...
#      2.  the item in ASSEMBLY_LIST is the name of `assembly studio` in onshape document.
...
#           ASSEMBLY_LIST='使用长U支架_SM40BL_sysID_assembly'
            ...
            WORKSPACE_ID_LIST='c80b55f27aca32e7170d61fc'
            # BODY_NAME should be the assembly dir name under descriptions folder.
            BODY_NAME="both_legs_main_assembly"
            #  TODO: make use of element_id.
            #ELEMENT_ID_LIST=...
            # the assembly name in onshape.
            ASSEMBLY_LIST="both_legs_main_assembly"
            ;;
            # -------- k-bot left leg
            kbot_left_leg)
            DOC_ID_LIST='f113281372e4169121004b65'
            WORKSPACE_ID_LIST='c80b55f27aca32e7170d61fc'
            # BODY_NAME should be the assembly dir name under descriptions folder.
            BODY_NAME="leg_L_subassembly"
            #  TODO: make use of element_id.
            #ELEMENT_ID_LIST=...
            # the assembly name in onshape.
            ASSEMBLY_LIST="leg_L_subassembly"
            ;;
            *)
